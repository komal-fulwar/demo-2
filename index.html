            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="header-inner">
                        ...
                        <p>India's First New Age Trading Floor: A Platform To Sculpt Young Minds and Trade Together.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="right-content-area ">
                        <span class="subtitle">Abhishek Mahankal</span>
                        <h3 class="title" style="font-size: 35px;">Anyone can trade with TRADR</h3>
                        <p style="font-size: 20px;  font-weight: 500;">With over 8 years of experience with trading in the stock market, managing 3 brokerage firms and a complete passion and goal to motivate millions, Abhishek Mahankal is the man behind TRADR. 
                            Featured in many national dailys' including Yahoo Finance, News Track, Daily Hunt and many more, he spread the word about teaching finance to youngster's and guide their way to stock market trading with a unique in-person one on one approach on the TRADR trading floor.
            ...
            <div class="row" style="padding-top:50px ;">
                ...
                <div class="col-lg-6">
                    <div class="right-content-area ">
                        ...
                        <h3 class="title" style="font-size: 35px;">Boost your business one step</h3>
                        <p style="font-size: 20px; font-weight: 500;"> TRADR - Let's Reach The Top Together, as the tagline suggests, along with the team of dedicated traders becomes a one-stop solution for all the stock market-related services which focuses on growing together as a whole.
                            Be it TRADR PERSONAL MENTORSHIP or ACCOUNT MANAGEMENT or TRADR APP SUBSCRIPTION, the TRADR team has you covered in all aspect of training and daily trading in the stock market.
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="left-content-area">
                                    ...
                                    <h3 class="title">TRADR PERSONAL MENTORSHIP PROGRAM<br>-We create traders from absolute scratch to a professional level.</h3>
                                        ...
                                        <ul>
                                          ...
                                          <ul>
                                            <li  style="font-size: 21px; border: gold solid 2px;">
                                                NOTE: Not any internet course, personal attention till all concepts are clear
                                                  </li>
                                          </ul>
                                </div>
                                <div class="btn-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="left-content-area">
                                    ...
                                    <p>The world is moving towards AI & automation, so match pace with the world by joining TRADR AI </p>
                                        <ul>
                                        <li class="two">
                    ...
                    <div class="how-it-works-tab-content white">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="left-content-area">
                                    <span class="subtitle" >Stock Market Training</span>
                                    <h3 class="title" >TRADR PERSONAL MENTORSHIP PROGRAM -We create traders from absolute scratch to a professional level.</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title white">
                        ...
                        <h3 class="title extra">Simple & easy to use application to assist with your trading journey</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title white">
                        ...
                        <p>At TRADR we belive in authenticity and spreding happiness. Here are few moments  of we collecting blessings from our free trades, client management and educatinal support   </p>
                    </div><!-- //. section title -->
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="card mb-2 newcard">
                                    <img class="card-img-top" src="assets/img/project-slider-imgs-1.jpg"
                                        ...
                                        <div class="card-body price-header ">
                                            ...
                                            <p class="card-text"></p>
                                            <a href="#" class="boxed-btn btn-rounded gd-bg-2">Read Article</a>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 " style="float:left">
                            <div class="card mb-2 newcard">
                                <img class="card-img-top" src="assets/img/project-slider-imgs-1.jpg"
                                    alt="Card image cap">
                                <div class="card-body price-header ">
                                    <h4 class="card-title  name">TRADR Got Featured In  ZEE 5</h4>
                                    <p class="card-text"></p>
                                    <a href="#" class="boxed-btn btn-rounded gd-bg-2">Read Article</a>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="download-area-wrapper white margin-top-120">
                        ...
                        <p>Tradr associates are connective and friendly.Connect with our Tradr associates personally for more details and clarify all your doubts.</p>
                        <div class="btn-wrapper">
                            <span class="subtitle">Connect with Akash</span>
                            <a href="#" class="boxed-btn btn-rounded gd-bg-1"><i class="flaticon-"></i> Mentorship </a>
                            <span class="subtitle">Connect with Yash</span>
                            <a href="#" class="boxed-btn btn-rounded gd-bg-2"><i class="flaticon-"></i>Subscription</a>
                                <span class="subtitle">Connect with Sagar </span>
                            <a href="#" class="boxed-btn btn-rounded gd-bg-3">Management
                                </a>
                        </div>
                    </div><!-- //. download area wrapper -->
                </div>
